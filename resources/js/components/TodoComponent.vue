  ...
  <div class="w-50">
    <form @submit.prevent="createTodo">
      <div class="input-group mb-3 w-100">
        <input type="text" class="form-control form-control-lg" v-model="data.todo" />
    ...
    <div class="w-100">
      ...
      >
        ...
        <span class="todofont" :class="{ 'completde' : todo.completed }">{{ todo.todo }}</span>
...
export default {
  ...
  methods: {
    ...
    deleteTodo(todo, i) {
      this.$confirm(
        "Are you want to permanently delete this todo?",
        "Warning",
        {
